...
odoo.define("odoosmes_report.report", function (require) {
    "use strict";
    ...
    ActionManager.include({
        ...
        _downloadReportXLSX1: function (url, actions) {
            framework.blockUI();
            var def = $.Deferred();
            var type = "controller";
        ...
        _triggerDownload: function (action, options, type) {
            ...
            if (type === "controller") {
                return this._downloadReportXLSX1(reportUrls[type], action).then(function () {
        ...
        _makeReportUrls: function (action) {
            ...
            reportUrls.controller = '/report/odoosmes.com/'+ action.report_name;
            return reportUrls;
        },
